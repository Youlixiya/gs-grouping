...
CUDA_VISIBLE_DEVICES=1 python train.py  -s data/ovs3d/room --images images_4  -m output/ovs3d/room --config_file config/gaussian_dataset/train.json
...
CUDA_VISIBLE_DEVICES=3 python render_ovs3d.py -m output/ovs3d/room --num_classes 256 --skip_train
CUDA_VISIBLE_DEVICES=3 python render_ovs3d.py -m output/ovs3d/room --num_classes 256 --reasoning --skip_train

CUDA_VISIBLE_DEVICES=4 python render_ovs3d.py -m output/ovs3d/sofa --num_classes 256 --skip_train
CUDA_VISIBLE_DEVICES=4 python render_ovs3d.py -m output/ovs3d/sofa --num_classes 256 --reasoning --skip_train