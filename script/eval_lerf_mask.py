...
gt_folder_path = os.path.join('data','gsgrouping', dataset_name,'segmentations')
# You can change pred_folder_path to your output
pred_folder_path = os.path.join('output','gsgrouping', dataset_name, 'test/ours_10000_text/test_mask')
